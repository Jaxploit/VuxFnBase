...
void DrawMenu()
{
	...
	ImGui::Begin("VuxFnBase", &menu::ShowMenu, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar);
